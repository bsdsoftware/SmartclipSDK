...
/**
 * The Tracking Notication protocol for the SCInstreamController.
 *
 *      @ingroup SCInstreamController
 */

__attribute__((visibility("default")))
@protocol SCInstreamTracking <NSObject>

@optional

/** @name [SCInstreamTracking] Notifications */

/**
 * 
 */
- (void)instreamController:(SCInstreamController *)controller didTrackEvent:(SCVAST2TrackEvent)event;
